/* ═══════════════════════════════════════════════
   HOFOFOCA — script.js
   Parallax · Form Logic · Animations · Submit
═══════════════════════════════════════════════ */
...
window.addEventListener('scroll', () => {
  if (!ticking) {
    requestAnimationFrame(() => {
      ...
      // Elementos flutuantes com speed individual
...
const urgencyLevels = [
  { emoji: '😴', text: 'Fofoquinha básica',    color: 'rgba(255,255,255,0.08)', border: 'rgba(255,255,255,0.1)' },
  { emoji: '👀', text: 'Ficou interessante..', color: 'rgba(0,194,232,0.08)',   border: 'rgba(0,194,232,0.25)' },
  { emoji: '😮', text: 'Tem história nisso!',  color: 'rgba(44,41,119,0.15)',   border: 'rgba(44,41,119,0.4)' },
  { emoji: '🔥', text: 'Quente quente!',       color: 'rgba(255,120,48,0.12)',  border: 'rgba(255,120,48,0.4)' },
  { emoji: '💣', text: 'BOMBA! Sai AGORA!',    color: 'rgba(181,31,77,0.15)',   border: 'rgba(181,31,77,0.6)' },
];
...
function validateForm() {
  ...
  // História (obrigatório, min 30 chars)
...
document.querySelectorAll('.section--step').forEach((s) => colorObserver.observe(s));
